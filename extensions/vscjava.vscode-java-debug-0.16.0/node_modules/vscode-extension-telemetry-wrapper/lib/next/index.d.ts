 ...
 */
export declare function instrumentOperationAsVsCodeCommand(command: string, cb: (...args: any[]) => any): vscode.Disposable;
/**
 ...
 */
export declare function sendInfo(operationId: string, dimensions: {
    [key: string]: string;
}, measurements: {
    [key: string]: number;
}): void;
 ...
 * @returns The instrumented callback.
 */
export declare function instrumentOperationStep(operationId: string, stepName: string, cb: (...args: any[]) => any): (...args: any[]) => any;
/**
 ...
 */
export declare function dispose(): Promise<any>;

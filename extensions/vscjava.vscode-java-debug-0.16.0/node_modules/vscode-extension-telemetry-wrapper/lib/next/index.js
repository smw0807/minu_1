 ...
 */
function instrumentOperationAsVsCodeCommand(command, cb) {
    const instrumented = instrumentOperation(command, (operationId, ...args) => __awaiter(this, void 0, void 0, function* () { return yield cb(...args); }));
 ...
 */
function sendInfo(operationId, dimensions, measurements) {
    reporter.sendTelemetryEvent(event_1.EventName.INFO, Object.assign({}, dimensions, { operationId }), measurements);
    if (isDebug) {
        // tslint:disable-next-line:no-console
        console.log(event_1.EventName.INFO, { eventName: event_1.EventName.INFO, dimensions, measurements });
    }
}

...
TelemetryEventNames.USER_CONFIG_INTELLICODE_TYPESCRIPT_COMPLETIONS_DISABLED = 'user-config-intellicode-typescript-completions-disabled';
...
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_RESULT_STATUS = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelResultStatus';
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_RESULT_VERSION = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelResultVersion';
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_RESULT_UPDATED = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelResultUpdated';
...
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_LANGUAGE_NAME = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelLanguageName';
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_STATUS_CODE = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelStatusCode';
TelemetryPropertyNames.INTELLICODE_SERVICE_GET_LATEST_MODEL_BLOB_NAME = TelemetryPropertyNames.FEATURE_NAME + 'IntelliCodeServiceGetLatestModelBlobName';
